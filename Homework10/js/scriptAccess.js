...
if (Number(age) >= 18 && trulyVerified === true && (isSubscribed === true || balanceCount > 0) ){
    const resultAccess = Number(age) >= 18 && trulyVerified === true && isSubscribed === true && balanceCount > 0;
...
if (age === '20'){
    ...
    const answer = alert(`Access restricted due to age`);
}